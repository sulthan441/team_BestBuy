...
function display(data) {
    document.getElementById("product-card").innerHTML = null;
    data.forEach(el => {
        ...
        rem.innerHTML = `remove <i class="fa fa-trash" aria-hidden="true"></i>`
        rem.style.marginRight = "5px";
